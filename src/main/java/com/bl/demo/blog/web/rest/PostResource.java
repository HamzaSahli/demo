package com.bl.demo.blog.web.rest;

import com.bl.demo.blog.domain.Post;
import com.bl.demo.blog.repository.PostRepository;
import com.bl.demo.blog.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.bl.demo.blog.domain.Post}.
 */
@RestController
@RequestMapping("/api")
@Transactional
